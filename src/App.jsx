...
const tokenModule = sdk.getTokenModule(
  "0x01DAD08bB2FD4033B29f5b28b681801E8CAe5787"
);

const voteModule = sdk.getVoteModule(
  "0x78e8c46A69A008AEFdCfCFBa7754e7f35A894016",
);
...
useEffect(() => {
  ...
  voteModule
    ...
    .then((proposals) => {
      ...
      console.log("🗳️ Proposals:", proposals)
    })
    .catch((err) => {
    ...
    return bundleDropModule
      ...
      .then((balance) => {
        ...
        if (balance.gt(0)) {
          ...
          console.log("🌟 this user has a membership NFT! (balance)", balance)
        } else {
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <span style={{display:'flex'}}>
        <label style={{fontSize:'4em', marginTop:'15px', marginRight:'-9px'}}>📚</label> 
        <h1>Échame la Mano DAO Member Page</h1>
        </span>
...
return (
  <div className="mint-nft">
    <span style={{display:'flex'}}>
    <label style={{fontSize:'4em', marginTop:'15px', marginRight:'-9px'}}>📚</label> 
    <h1>Mint free DAO Membership NFT</h1>
    </span>    
    <br></br>
    <button
      disabled={isClaiming}
